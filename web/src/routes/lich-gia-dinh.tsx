...
import {
  ...
  type EventCategory,
  type EventScope,
} from "@/lib/family-events.functions";
...
function CalendarPage() {
  ...
  const list = useServerFn(listFamilyEvents);
  const del = useServerFn(deleteFamilyEvent);
...
function EventDialog({
  ...
  const upsert = useServerFn(upsertFamilyEvent);
