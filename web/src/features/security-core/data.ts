...
/** True nếu `buildingStatus` đang là dữ liệu mẫu (chưa kết nối hệ thống thật). */
export const buildingStatusIsDemo = true;
...
export const securityServiceGrid: SecurityServiceItem[] = [
  ...
  { id: "shipping", icon: Send, label: "Gửi hàng đi", desc: "Qua đơn vị vận chuyển", color: "text-pink", bg: "bg-pink/10" },
...
export const securityServiceCatalog: SecurityCatalogGroup[] = [
  ...
  {
    id: "reminder",
    title: "Hỗ trợ khi vắng nhà",
    subtitle: "Bảo vệ hỗ trợ căn hộ khi cư dân đi vắng",
    icon: BellRing,
    accent: "text-info",
    tint: "bg-info/10",
    items: [
      { id: "rem-utility", icon: Lightbulb, label: "Nhắc tắt điện / nước", desc: "Theo khung giờ cư dân tự cài đặt" },
      { id: "rem-process", icon: ShieldCheck, label: "Bảo vệ hỗ trợ khi vắng nhà", desc: "Mở cửa, tưới cây, chăm thú cưng, kiểm tra căn hộ…" },
    ],
  },
  {
    id: "care",
